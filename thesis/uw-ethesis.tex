...
\input{./evaporation/evaporation.tex}

\input{./analysis/analysis.tex}

\input{./growth/growth.tex}
...
%\bibliographystyle{apalike} %right format byt mess up with order of appearance
%\bibliographystyle{unsrt} %(does not show url) right order but mess up with format
